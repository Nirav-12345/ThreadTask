...
class Program
{
    public static void Main(string[] args)
    {
        ...
        //listperson.Add(new AdBook(1,"Nirav","GopalNagar","Asansol","westBengal","425235","niravpandit0002@gmail.com",527527622));
        //listperson.Add(new AdBook(2, "Jhon", "Florida", "USA", "cal", "4252535", "jhon@gmail.com", 5355555565));
        //listperson.Add(new AdBook(3, "RussinanTeen", "Canada", "Ve", "cal", "4252345", "Russian@gmail.com", 67687687));
